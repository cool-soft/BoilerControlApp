    ...
    def get_required_temp(self, start_datetime, end_datetime):
        ...
        for weather_temp in weather_temp_arr:
            ...
            required_temp_at_home_in_list.append(required_temp[
                                                     temp_requirements.constants.column_names.FORWARD_PIPE_TEMP])
            required_temp_at_home_out_list.append(required_temp[
                                                      temp_requirements.constants.column_names.BACKWARD_PIPE_TEMP])
        ...
        temp_requirements_df = pd.DataFrame({
            ...
            temp_requirements.constants.column_names.FORWARD_PIPE_TEMP: required_temp_at_home_in_list,
            temp_requirements.constants.column_names.BACKWARD_PIPE_TEMP: required_temp_at_home_out_list
        })
