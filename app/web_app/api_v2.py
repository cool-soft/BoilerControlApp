...
def get_predicted_boiler_t(
    ...
    """
        ...
        - YYYY-MM-DD*HH:MM[:SS[.fff[fff]]]][+HH:MM[:SS[.ffffff]]]] где * - 1 любой символ

        Примеры:
        - 2020-01-30 00:17+05:00 - Временная зона для парсинга берется из самой строки, предпочтительный формат.
