...
from backend.services.updater_service.old_updater_service import OldUpdaterService


class OldUpdateContainer(containers.DeclarativeContainer):
    ...
    updater_service = providers.Singleton(OldUpdaterService,
